package P07_ReflectionAndAnnotation;

import P07_ReflectionAndAnnotation.annotations.Author;
import P07_ReflectionAndAnnotation.annotations.Subject;
...
public class Main {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
        ...
        // Fields
        Optional<Field> optionalField = Arrays.stream(aClass.getDeclaredFields()).filter(f -> f.getName().equals("some")).findFirst();
